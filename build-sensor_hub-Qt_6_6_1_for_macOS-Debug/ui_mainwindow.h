...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        listWidget->setGeometry(QRect(20, 40, 111, 241));
        listWidget->setMinimumSize(QSize(0, 0));
        searchBox = new QLineEdit(centralwidget);
        searchBox->setObjectName("searchBox");
        searchBox->setGeometry(QRect(10, 10, 241, 21));
    ...
    {
        MainWindow->setWindowTitle(QCoreApplication::translate("MainWindow", "sensor hub", nullptr));
